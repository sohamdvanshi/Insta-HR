...
// 1. Update CandidateProfile model to add photoUrl
let model = fs.readFileSync('src/models/CandidateProfile.js', 'utf8');
model = model.replace(
  `  resumeUrl: {
...
fs.writeFileSync('src/models/CandidateProfile.js', model);
console.log('✅ Model updated');

// 2. Update candidate controller
const controller = `const { CandidateProfile, Job } = require('../models/index');
...
`;
fs.writeFileSync('src/controllers/candidate.controller.js', controller);
console.log('✅ Controller updated');

// 3. Update candidate routes
...
`;
fs.writeFileSync('src/routes/candidate.routes.js', routes);
console.log('✅ Routes updated');
console.log('All backend updates done!');