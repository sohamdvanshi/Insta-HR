...
fs.writeFileSync('src/app/subscription/page.tsx', page);
console.log('✅ Subscription page created at src/app/subscription/page.tsx');
console.log('🎉 Done! Test at http://localhost:3000/subscription');